...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../Vistas/AgregarUsuarios.php">Administrador</a>
            </div>
            <!-- Top Menu Items -->
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>Ingresar</strong>
                                        </h5>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                       <!-- <li>
                        ...
                        <li class="divider"></li>-->
                        <li>
                            <a href="../index.php?cerrar_sesion=true""><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="">
                        <a href="../Vistas/AgregarUsuarios.php"><i class="fa fa-fw fa-user"></i> Agregar Usuarios</a>
                    </li>
                    <li class="">
